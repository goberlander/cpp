/*
Program: With reMorse
Author: Glenn Oberlander
Date: 4/25/2018
*/

/*This program will convert the user's input into Morse code and output result. Up to 50 characters. */
...
int main()
{
    ...
    // Iterates through letters and prints out corresponding Morse code
    for(int j = 0; j < stringLength; j++)
    {
        ...
        case '.': cout << ".-.-.-" << endl; break;
        case '?': cout << "..--.." << endl; break;
        default: cout << "You've entered invalid characters." << endl; return 0;
        }
    }
}