...
while (i<12){
    ...
    cout << "The Month with the Highest amount of Rainfall is: " << BigMonth << " with " << Big << " units of rainfall." << endl;//print highest rainfall
...
for(int a = 0; a<12; a++){ //for loop to run through rainArray
    ...
    cout << "The Month with the Smallest amount of Rainfall is: " << SmallMonth << " with " << Small << " units of rainfall" << endl; //print smallest rainfall
